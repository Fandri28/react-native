...
export default function EvaluationList() {
    ...
    const fetchEvaluations = () => {
        ...
        axios.get(ap+'/assessments')
            .then(response => {
                setEvaluations(response.data.reverse());
                setLoading(false);
            })
            .catch(error => {
    ...
    const handleDelete = (id) => {
        ...
        axios.delete(re)
            ...
            .then(response => {
                setEvaluations(prevEvaluations => prevEvaluations.filter(evaluation => evaluation._id !== id));
            })
            .catch(error => {
    ...
    const handleEdit = (id) => {
        navigation.navigate('ModifierEvaluation', { id });
    };

    const handleAdd = () => {
        navigation.navigate('AjoutEvaluation');
    };
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Liste des Évaluations</Text>
            </View>
            {menuVisible && (
